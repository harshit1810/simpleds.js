...
function CircularLinkedListNode(nodeValue) {
    sharedComponents.NODE_ARGS_INTERCEPTOR.call(arguments);
    circularListAssertion.validNodeValue(nodeValue);
    sharedComponents.Node.call(this, nodeValue);
    Object.assign(this, sharedComponents.makeGetterSetter(
        'Next',
        sharedComponents.NEW_NODE_DEFAULT_REFERENCE,
        circularListAssertion.validNodeValue
    ));
}
CircularLinkedListNode.getValidNode = function (value) {
    // if (value instanceof CircularLinkedListNode) {
    //     return value;
    // } else {
    //     var _node_ = new CircularLinkedListNode(value);
    //     return _node_;
    // }
    return (value instanceof CircularLinkedListNode) ? value : new CircularLinkedListNode(value);
};
module.exports.ERROR_NAME = 'CircularLinkedListError';
module.exports.CircularLinkedListNode = CircularLinkedListNode;
module.exports.circularListAssertion = circularListAssertion = (function () {
    ...
    return {
        ...
        validNodeValue: function (value) {
            if (value instanceof CircularLinkedListNode || value === null) {
                return value;
            }
